...
export OPEN_SPIEL_BUILD_WITH_LIBTORCH_DOWNLOAD_URL="${OPEN_SPIEL_BUILD_WITH_LIBTORCH_DOWNLOAD_URL:-"https://download.pytorch.org/libtorch/cpu/libtorch-cxx11-abi-shared-with-deps-1.8.1%2Bcpu.zip"}"
...
export OPEN_SPIEL_BUILD_WITH_PAPERS="${OPEN_SPIEL_BUILD_WITH_PAPERS:-OFF}"
